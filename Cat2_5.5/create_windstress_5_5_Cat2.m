...
% Maximum wind speed = 44.67 m/s, or 160.8 km/h (Cat 2)
clc
clear
% set output file names
uwndfn = 'ocean_frc_uwstress_5_5_Cat2.nc';
vwndfn = 'ocean_frc_vwstress_5_5_Cat2.nc';
...
P_N = 1005; 
P_C = 965; % Cat 2 is between 965 and 979
R_Max = 50*1e3; %unit:m
