...
!      DO j=JstrT,JendT
!        DO i=IstrT,IendT
!           IF (xr(i,j).gt.2100000) THEN
!             h(i,j)=2000.0_r8
!           ELSE IF (xr(i,j).le.2100000 .AND. xr(i,j).ge.1900000) THEN
!             h(i,j) =1000.0_r8*TANH((xr(i,j)-2000000.0_r8)/50000.0_r8)+1050.0_r8
!           ELSE
!             h(i,j)=50.0_r8
!           END IF
!        END DO
!      END DO 
!
!           IF (xr(i,j).gt.2600000) THEN
!             h(i,j)=2000.0_r8
!           ELSE IF (xr(i,j).le.2600000 .AND. xr(i,j).ge.2400000) THEN
!             h(i,j)=50.0_r8+0.00975_r8*(xr(i,j)-2400000)
!           ELSE
!             h(i,j)=50.0_r8
!           END IF
!        END DO
