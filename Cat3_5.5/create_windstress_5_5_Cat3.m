...
% Maximum wind speed = 54.56 m/s, or 196.4 km/h (Cat 3)
clc
clear
% set output file names
uwndfn = 'ocean_frc_uwstress_5_5_Cat3.nc';
vwndfn = 'ocean_frc_vwstress_5_5_Cat3.nc';
...
P_N = 1005; 
P_C = 950; % Cat 3 is between 945 and 964
R_Max = 50*1e3; %unit:m
