...
% up over one day.
%
% Translation speed = 5.5 m/s, or 19.8 km/h
% Maximum wind speed = 66.88 m/s, or 240.76 km/h (Cat 4)
clc
clear
% set output file names
uwndfn = 'ocean_frc_uwstress_5_5_Cat4.nc';
vwndfn = 'ocean_frc_vwstress_5_5_Cat4.nc';
...
P_N = 1005; 
P_C = 930; % Cat 4 is between 944 and 920
R_Max = 50*1e3; %unit:m
